...
import { Edit, Eye, LogOut, Loader2, Menu } from "lucide-react"
  ...
  return (
    <div className={`min-h-screen ${currentTheme}`} style={{ backgroundColor }}>
      <main className="container mx-auto px-4 py-8">
        <div
          className="mb-8 hidden md:flex items-center justify-between sticky top-4 z-40 backdrop-blur-md py-4 px-8 rounded-2xl border-2 shadow-lg"
          style={{
